...
class LeftMenuViewController: UIViewController {
    ...
    lazy var tableView: UITableView = {
        ...
        /*
            ...
            Displays custom fonts on console, select custom fonts from this list
...
extension LeftMenuViewController: UITableViewDelegate, UITableViewDataSource {
    ...
    func tableView(tableView: UITableView, cellForRowAtIndexPath indexPath: NSIndexPath) -> UITableViewCell {
        ...
        let titles: [String] = ["Home", "Photo Library", "Messages" , "Settings", "Log Out"]
        
        let images: [String] = ["nova", "photogrid", "hangouts7", "settingsl", "lockdown"]
        
        cell.backgroundColor = UIColor.clearColor()
        cell.textLabel?.font = UIFont(name: "Roboto-Black", size: 21)
